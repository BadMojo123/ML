    ...
    while True:
        ...
        if (msg != 'NA'):
            ...
            if (command == 'DATAEURUSD5'):
                ...
                Recomendations[6] = AdvisorDNN_M5Classifier.predict(
                    prediction[0, (False, True, False, True)].reshape(1, -1))
            ...
            if (command == 'DATAEURUSD1'):
                ...
                Recomendations[2] = AdvisorDNN_M1Classifier.predict(
                    prediction[0, (False, True, False, True)].reshape(1, -1))
...
def ExecuteOrders(OpenOrders, CurentOrder, Recomendations):
    ...
    if (OpenOrders == 0):
        ...
        elif (Recomendations[2] == -1 and Recomendations[6] == -1 and Recomendations[1] == 1 and Recomendations[
            5] == 1):
